...
const buttonConfig = {
    ...
    contained:
        "bg-primary-dark text-white hover:text-primary-dark hover:bg-white hover:shadow-md disabled:bg-opacity-20 disabled:text-opacity-50 disabled:border-none",
}
